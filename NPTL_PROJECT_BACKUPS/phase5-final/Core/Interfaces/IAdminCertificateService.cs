...
public interface IAdminCertificateService
{
    ...
    Task<AdminCertificateDto> UploadCertificateAsync(Guid registrationId, Stream fileStream, string fileName, string contentType, long fileLength, Guid? adminUserId, string? ipAddress, CancellationToken cancellationToken = default);
