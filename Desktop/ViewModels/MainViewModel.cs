...
public class MainViewModel : ViewModelBase
{
    ...
    private void InitializeNavigation()
    {
        ...
        if (IsStudent)
        {
            ...
            AddNavItem("Courses", "📚", () => _navigationService.NavigateShellTo(new PlaceholderViewModel("NPTEL Course Enrollment", "Student NPTEL course registration and catalog selection will be fully functional in Phase 2.")));
            AddNavItem("Notifications", "🔔", () => _navigationService.NavigateShellTo(new PlaceholderViewModel("Notifications", "Department notifications and course circulars will be accessible in Phase 2.")));
